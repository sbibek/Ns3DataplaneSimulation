...
#ifndef PROBE_LISTENER_H
#define PROBE_LISTENER_H
...
class ProbeListener : public Application
{
public:
  /**
...
private:
  ...
  void HandleProbeData(ProbeHeader& header, std::vector<ProbePayload>& payload, Address& from);
